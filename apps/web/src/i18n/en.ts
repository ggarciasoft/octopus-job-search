...
export const en = {
  ...
  // --- M4: applications, packets, the runner and the tracker ---------------
  'applications.title': 'Applications',
  'applications.intro':
    'Each application is one attempt at one job. Starting one records the intent and nothing else: the CV, the answers and the approval are separate decisions on the review screen.',
  'applications.startFor': 'Start an application for',
  'applications.chooseJob': 'Choose a job',
  'applications.start': 'Start tracking',
  'applications.starting': 'Starting…',
  'applications.allTracked': 'Every job you have discovered already has an application.',
  'applications.tableCaption': 'Applications in progress',
  'applications.columnRole': 'Role',
  'applications.columnStatus': 'Status',
  'applications.columnUpdated': 'Last change',
  'applications.emptyTitle': 'No applications yet',
  'applications.emptyBody':
    'Nothing has been prepared. Discover a job first, then start an application for it.',
  'applications.emptySuggestion': 'Browse the jobs you have discovered',

  'application.status.draft': 'Draft',
  'application.status.draft.description': 'Started, with nothing prepared yet.',
  'application.status.preparing': 'Preparing',
  'application.status.preparing.description': 'A packet is being put together.',
  'application.status.needsInput': 'Needs your answer',
  'application.status.needsInput.description':
    'A required question has no answer. Nothing will be guessed for it.',
  'application.status.readyForReview': 'Ready for review',
  'application.status.readyForReview.description':
    'Everything is answered. Read the packet and approve it if it is right.',
  'application.status.approved': 'Approved',
  'application.status.approved.description':
    'You approved this exact content. The approval expires, and any change to your profile, the job, the CV or the destination withdraws it.',
  'application.status.filling': 'Filling',
  'application.status.filling.description': 'A paired runner has the form open.',
  'application.status.awaitingUserSubmit': 'Waiting for submission',
  'application.status.awaitingUserSubmit.description':
    'The form is filled and waiting for you. Nothing has been sent.',
  'application.status.submitted': 'Submitted',
  'application.status.submitted.description': 'Recorded as sent.',
  'application.status.outcomeUnknown': 'Outcome unknown',
  'application.status.outcomeUnknown.description':
    'We could not tell whether it went through. That is not a failure and not a success, and nothing will retry on its own.',
  'application.status.failed': 'Failed',
  'application.status.failed.description': 'Something went wrong before submission.',
  'application.status.cancelled': 'Cancelled',
  'application.status.cancelled.description': 'You stopped this before it was sent.',
  'application.status.interview': 'Interview',
  'application.status.interview.description': 'You heard back and it is moving.',
  'application.status.rejected': 'Rejected',
  'application.status.rejected.description': 'They said no.',
  'application.status.offer': 'Offer',
  'application.status.offer.description': 'They made an offer.',
  'application.status.withdrawn': 'Withdrawn',
  'application.status.withdrawn.description': 'You withdrew it.',

  'application.submitted.verified': 'Submitted — verified',
  'application.submitted.reported': 'Submitted — reported by you',
  'application.submitted.unevidenced': 'Submitted — no evidence recorded',

  'evidence.adapterObserved': 'Seen on the confirmation page',
  'evidence.userReport': 'Reported by you',
  'evidence.none': 'No evidence',

  'applicationEvent.created': 'Application started',
  'applicationEvent.packetCreated': 'Packet prepared',
  'applicationEvent.packetApproved': 'Packet approved',
  'applicationEvent.approvalInvalidated': 'Approval withdrawn: the content changed',
  'applicationEvent.approvalExpired': 'Approval expired',
  'applicationEvent.fillRequested': 'Filling requested',
  'applicationEvent.fillPaused': 'Runner paused',
  'applicationEvent.fillFailed': 'Filling failed',
  'applicationEvent.submitted': 'Recorded as submitted',
  'applicationEvent.outcomeRecorded': 'Outcome recorded',
  'applicationEvent.cancelled': 'Cancelled',
  'applicationEvent.note': 'Note',

  'timeline.empty': 'Nothing has happened yet.',
  'timeline.actor.user': 'You',
  'timeline.actor.system': 'System',
  'timeline.actor.runner': 'Runner',
  'timeline.transition': '{from} → {to}',

  'staleness.profileRevisionChanged': 'Your profile changed after this packet was built.',
  'staleness.jobRevisionChanged': 'The job posting changed after this packet was built.',
  'staleness.resumeChanged': 'The CV file changed after this packet was built.',
  'staleness.destinationChanged': 'The application URL for this job changed.',
  'staleness.formSchemaChanged': 'The form itself changed since this packet was approved.',
  'staleness.approvalExpired': 'The approval ran out.',

  'answerProvenance.userEntered': 'Typed by you',
  'answerProvenance.answerBank': 'Saved answer',
  'answerProvenance.profileFact': 'From your profile',
  'answerProvenance.preference': 'From your preferences',

  'unresolved.noAnswer': 'You have not answered this question.',
  'unresolved.newQuestion': 'The form asked something this packet does not cover.',
  'unresolved.unsupportedWidget': 'The control is one the runner cannot drive.',
  'unresolved.needsExactMapping': 'Your answer does not exactly match any offered option.',
  'unresolved.neverInferable':
    'An assessment, identity or demographic question. These are never answered from a saved value.',
  'unresolved.fileUploadBlocked': 'The CV could not be attached.',

  'packet.heading': 'What will be sent',
  'packet.revision': 'Packet revision {revision}',
  'packet.destination': 'Destination',
  'packet.connector': 'Adapter {connector} ({version})',
  'packet.staleTitle': 'This packet is out of date',
  'packet.unresolvedTitle': 'Unanswered required questions',
  'packet.unresolvedBody': '{count} required question(s) still need an answer.',
  'packet.answersHeading': 'Answers',
  'packet.noAnswers': 'This packet carries no answers yet.',
  'packet.answerMissing': 'Not answered',
  'packet.required': 'Required',
  'packet.neverReuse': 'Never reused',
  'packet.contentHash': 'Content hash',
  'packet.approval': 'Approval',
  'packet.notApproved': 'Not approved',
  'packet.approvedUntil': 'Approved until {expires}',

  'answers.heading': 'Answers for this application',
  'answers.empty': 'No questions yet. Add the ones the form asks for.',
  'answers.useStored': 'Use saved answer',
  'answers.remember': 'Remember this answer',
  'answers.rememberDescription': 'Saved for reuse, and only where you approved it.',
  'answers.neverReuseNotice':
    'This question is never answered from a saved value; answer it on the form itself.',
  'answers.addLabel': 'Add a question',
  'answers.addDescription': 'Type the question exactly as the form asks it.',
  'answers.add': 'Add',

  'review.viewJob': 'View the job posting',
  'review.duplicateTitle': 'This may be the same posting as another application',
  'review.duplicateBody':
    '{count} other application(s) are for a job with the same employer and title. They are kept separate; check before sending both.',
  'review.noPacketTitle': 'Nothing prepared yet',
  'review.noPacketBody': 'Choose a CV and answer the form questions, then save the packet.',
  'review.buildHeading': 'Prepare the packet',
  'review.buildIntro':
    'Saving writes a new packet revision. Any approval on the previous one is withdrawn, because it was an approval of different content.',
  'review.resume': 'CV to send',
  'review.resumeDescription': 'Only finished CVs this job can use are listed.',
  'review.resumeChoose': 'Choose a CV',
  'review.resumeOriginal': 'Your own file, unchanged ({created})',
  'review.resumeTailored': 'Generated for this job ({created})',
  'review.noResumeTitle': 'No CV is ready',
  'review.noResumeBody': 'Generate one or upload your own before preparing a packet.',
  'review.cvStudioLink': 'Open the CV studio',
  'review.savePacket': 'Save packet',
  'review.saving': 'Saving…',
  'review.approve': 'Approve this packet',
  'review.approving': 'Approving…',
  'review.approveNotice':
    'Approving records that you read this exact content. It expires, and changing your profile, the job, the CV or the destination withdraws it.',
  'review.historyHeading': 'History',

  'fill.heading': 'Fill assistant',
  'fill.device': 'Paired runner',
  'fill.start': 'Open the form and fill it',
  'fill.starting': 'Starting…',
  'fill.noRunnerTitle': 'No paired runner',
  'fill.noRunnerBody':
    'Filling happens on your own machine, in a browser you can see. Pair the desktop runner to use it; you can also apply by hand and record the outcome.',
  'fill.pairLink': 'Pair a device',
  'fill.inProgressTitle': 'The runner has the form open',
  'fill.inProgressBody': 'Watch the browser window it opened. It will stop before submitting.',
  'fill.awaitingSubmitTitle': 'The form is filled and waiting for you',
  'fill.awaitingSubmitBody':
    'Nothing has been sent. Check every field in the browser window, then submit it yourself.',
  'fill.pausedTitle': 'The runner paused',
  'fill.pausedBody': 'The form asked something this packet does not answer:',
  'fill.neverSubmits':
    'The runner never presses submit. That is a permanent design decision, not a missing feature.',
  'fill.reasonsSummary': 'Why a field can be left for you',
  ...
  'devices.originsDescription':
    'Comma separated, for example https://boards.greenhouse.io. Leave empty to allow only the exact destination of each approved packet.',
  'devices.pair': 'Create a pairing code',
  'devices.pairing': 'Creating…',
  'devices.codeTitle': 'Your pairing code',
  'devices.codeBody':
  ...
  'devices.notYetPaired': 'Has not exchanged its code yet',
  'devices.expires': 'Expires {when}',
  'devices.revoke': 'Revoke',
  'device.status.pending': 'Waiting to pair',
  'device.status.paired': 'Paired',
  'device.status.revoked': 'Revoked',
  'device.status.expired': 'Expired',

  'tracker.title': 'Tracker',
  'tracker.intro': 'Where every application stands, and what that is based on.',
  'tracker.evidenceTitle': 'Verified and reported are different things',
  'tracker.evidenceBody':
    'A submission a runner watched land is marked verified. One you told us about is marked as reported by you. Absence of evidence is not failure and not success.',
  'tracker.emptyTitle': 'Nothing tracked yet',
  'tracker.emptyBody': 'Applications appear here as soon as you start one.',
  'tracker.emptySuggestion': 'Start an application',
  'tracker.submittedAt': 'Submitted {when}',
  'tracker.evidenceKind': 'Evidence',
  'tracker.outcomeLabel': 'What happened',
  'tracker.reference': 'Reference',
  'tracker.referenceDescription': 'Any confirmation number the employer showed you.',
  'tracker.note': 'Note',
  'tracker.record': 'Record it',
  'tracker.recording': 'Recording…',
  'tracker.evidenceNotice': 'This will be recorded as: {evidence}.',

  'outcome.submitted': 'I submitted it',
  'outcome.notSubmitted': 'It was never submitted',
  'outcome.unknown': 'I cannot tell whether it went through',
  'outcome.interview': 'They invited me to interview',
  'outcome.rejected': 'They rejected it',
  'outcome.offer': 'They made an offer',
  'outcome.withdrawn': 'I withdrew it',
