...
| Milestones complete                 | 4 of 8 (M0, M1, M2, M3); M4 in progress, 2 of 10 pilot workflows run, 20 of 28 acceptance scenarios passing — see the milestone table for what "complete" covers                                                                                                                                                                                                                                                                                                                                                                                         |
...
AT27–AT28) and the M6 hosted gate (all scenarios) are both **not met**. 20 of
the 28 scenarios pass; the pilot gate still needs AT12, AT16, AT18, AT25 and
AT27–AT28.
