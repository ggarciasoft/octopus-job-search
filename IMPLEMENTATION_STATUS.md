...
**Last updated: 2026-09-20** · **M0 and M1 complete and verified on the Compose stack.** Next: **M2 (Job discovery)**
...
|                                     |                                                                                                                                                                                                                                                                                                                                                                                            |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Functional requirements implemented | 3 of 14 (PR01, PR02, PR03)                                                                                                                                                                                                                                                                                                                                                                 |
| Acceptance scenarios passing        | 8 of 28 (AT01, AT02, AT03, AT04, AT07, AT09, AT11, AT19)                                                                                                                                                                                                                                                                                                                                   |
...
| M2  | Job discovery                          | **In progress** | Fixture/live-read jobs discovered; duplicates and provenance correct            | Contracts landed (`packages/contracts/src/schemas/jobs.ts`, `tasks/fetch-board.ts`): normalised job, sources, scans, job views with provenance and possible-duplicate warnings, `fetch_board`/`fetch_job` task I/O. The ten M2 routes are in the manifest and explicitly deferred, so `GET /me` does not advertise `fetch_board`/`fetch_job` yet. Worker (URL fetcher with SSRF protections, Greenhouse/Lever connectors) and API (sources, scans, scheduler, dedup/closure) are being built; web screens follow.                                                                                                                                                                                    |
