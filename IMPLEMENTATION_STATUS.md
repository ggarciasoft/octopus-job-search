...
| **Never executed**                  | `scripts/dev.*` (syntax-checked only); `backup.sh --age-recipient` and `backup.ps1 -AgeRecipient` (only the gpg and plaintext paths ran); any `.ps1` under PowerShell 7; `restore.ps1`'s file-pruning with a non-empty path list under the full script (it ran on its own under 5.1 in AT26); the `local-ai` Ollama profile; any image build on a host WITHOUT TLS interception (the no-secret path is verified only by construction); macOS/Linux hosts                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
